	...
	<div class="container">
		...
		<nav class="pull-right"><!-- page menu -->
			...
			<ul class="list-inline">
				<li class="active">Mensaje</li>
				<li><a href="{{ url('cotizacion/create') }}">Cotización</a></li>
...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-9 col-sm-9">
			...
			<h4>¿Cuáles son sus preguntas? ¿Qué le gustaría conocer?</h4>
			<h4>Llene los campos y sea tan específico como le sea posible en su mensaje. </h4>
			<!--
				MESSAGES
			...
			<form action="{{ url('mensajes/postMessage') }}" method="post" enctype="multipart/form-data">
							...
							<div class="col-md-12">
								...
								<textarea  maxlength="10000" rows="8" class="form-control" name="message" id="message"></textarea>
                                 @if ($errors->has('message'))
                                    <span style="color:red!important" class="help-block"><strong>{{ $errors->first('message') }}</strong></span>
                                @endif
							</div>
						</div>
					</div>
