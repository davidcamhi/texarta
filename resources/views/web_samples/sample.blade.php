...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-9 col-sm-9">
			...
			<form action="{{ url('muestras/postSample') }}" method="post" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-md-12">
						<button type="submit" class="btn btn-primary"><i class="fa fa-check"></i> SOLICITAR MUESTRA</button>
					</div>
				</div>
			</form>
