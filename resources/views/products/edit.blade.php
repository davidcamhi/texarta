...
<div class="page-content">
	...
	<!-- END PAGE BAR -->
	<!-- BEGIN PAGE TITLE-->
	<h3 class="page-title"> Editar Producto
	</h3>
	<!-- END PAGE TITLE-->
	<!-- END PAGE HEADER-->
	<div class="row">
	                ...
	                <div class="tab-pane active" id="tab_1">
	                    ...
	                    <div class="portlet light bordered">
	                        <div class="portlet-body form">
	                            <!-- BEGIN FORM-->
	                             {!! Form::model($product, ['method' => 'PATCH', 'action' =>  ['ProductsController@update', $product->id],'enctype' => 'multipart/form-data'] ) !!}
	                                    ...
	                                    <div class="row">
	                                        <div class="col-md-6">
	                                            <div class="form-group">
	                                                ...
	                                                <input type="text" id="name" name="name" class="form-control" placeholder="Nombre del producto" value="{{ $product->name }}">
                                        ...
                                        <div class="row">
	                                        <div class="col-md-6">
	                                            <div class="form-group">
	                                                ...
	                                                <input type="text" id="fiber" name="fiber" class="form-control" placeholder="Fibra" value="{{ $product->fiber }}">
	                                            </div>
	                                        </div>
	                                        <!--/span-->
	                                         <div class="col-md-6">
	                                            <div class="form-group">
	                                                ...
	                                                <input type="text" id="fabric" name="fabric" class="form-control" placeholder="Tejido" value="{{ $product->fabric }}">
	                                            </div>
	                                        </div>
	                                        <!--/span-->
	                                    </div>
                                        <div class="row">
	                                        <div class="col-md-6">
	                                            <div class="form-group">
	                                                ...
	                                                <input type="text" id="weight" name="weight" class="form-control" placeholder="Peso" value="{{ $product->weight }}">
	                                            </div>
	                                        </div>
	                                        <!--/span-->
	                                         <div class="col-md-6">
	                                            <div class="form-group">
	                                                ...
	                                                <input type="text" id="width" name="width" class="form-control" placeholder="Ancho" value="{{ $product->width }}">
	                                            </div>
	                                        </div>
	                                        <!--/span-->
	                                    </div>
                                        <div class="row">
	                                        <div class="col-md-6">
	                                            <div class="form-group">
	                                                ...
	                                                <input type="text" id="backing" name="backing" class="form-control" placeholder="Backing" value="{{ $product->backing }}">
	                                            </div>
	                                        </div>
	                                        <!--/span-->
	                                         <div class="col-md-6">
	                                            <div class="form-group">
	                                                ...
	                                                <input type="text" id="pattern" name="pattern" class="form-control" placeholder="Patrón" value="{{ $product->pattern }}">
	                                            </div>
	                                        </div>
	                                        <!--/span-->
	                                    </div>
