...
var Dashboard = function() {
    ...
    return {
        ...
        initChartRequests :function() {
            var chart = AmCharts.makeChart("chart_requests", {
                "type": "serial",
                "theme": "light",
                "pathToImages": App.getGlobalPluginsPath() + "amcharts/amcharts/images/",
                "autoMargins": false,
            ...
            $('#chart_requests').closest('.portlet').find('.fullscreen').click(function() {
                chart.invalidateSize();
            });
        },
	    ...
	    initChartGenders : function() {
	        var chart = AmCharts.makeChart("chart_genders", {
	            "type": "pie",
	            "theme": "light",
	        ...
	        $('#chart_genders').closest('.portlet').find('.fullscreen').click(function() {
	            chart.invalidateSize();
	        });
	    },
        init: function() {
            ...
            this.initChartSample1();
            this.initChartSample2();
            this.initChartSample6();
            this.initChartRequests();
            this.initChartGenders();
        }
    };
